...
{	
	...
	for (int i = 0; i < position_desired.size(); i++)
	{
		...
		// updates the input channels of the q8
		q8.update_input();
...
int main(int argc, char* argv[])
{
	...
	Q8Usb		q8;						// create a new q8 device to read motor input
